        ...
        <AttachStep index={5} fill>
          <View style={styles.navSection}>
            {[
              ...
              { icon: 'search', title: 'Web Search', desc: 'Choose search provider and API key', screen: 'WebSearchSettings' as const },
              { icon: 'bookmark', title: 'Memory', desc: 'Saved local facts and research notes', screen: 'Memory' as const },
